...
to make the odds fair, Brownlow should pay out `r mean(saveBank)`   
...
```
 ...
 for a fair bet , the class size should be `r numClass`
...
For the game to go as described, Brownlow should pay out `r mean(saveBank)`
